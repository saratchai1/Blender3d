...
def main():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            report['checks'].append('Public HTTPS Automatic BOQ rendered 27 rows including eight validated sanitary pipe rows totaling 91.272 m; scored audit subset remains 95% coverage and 100% detected-row accuracy')
            report['checks'].append('Public generated JSON proves reference isolation, release blockers zero, A-06 roof provenance retained, and all published evidence pages <= 71')
