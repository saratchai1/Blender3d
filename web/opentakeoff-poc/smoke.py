...
def main():
    ...
    with sync_playwright() as p:
      ...
      try:
        ...
        page.screenshot(path=str(a.out/'01-automatic-boq.png'),full_page=True);evidence['checks'].append('Family4 Automatic BOQ renders 27 rows including eight validated sanitary pipe rows totaling 92.500 m with source fence and cross-sheet DN15 evidence intact')
